...
import GeneticAlgorithms.GA;
import GeneticAlgorithms.Genetic;
...
public class FuzzyRuntimeGA extends RuntimeAlgorithm
{
	public FuzzyRuntimeGA(BuildTimeAlgorithm aBuilder)
	{
		super(aBuilder);
	}
	...
	public void run(ArrayList<DataCenter> aDatacenters, Workflow aWorkflow) throws DistributionException
	{
		...
		ArrayList<Task> PSOReadyTasks = getReadyTasks();
               ...
               /* GA geneticAlgorithm = Preset.getDefaultGA();
                ...
                */
                ...
                Genetic ga = new Genetic(PSOReadyTasks,fUsedDatacenters);
                double[] b = new double[PSOReadyTasks.size()] ;
                b= ga.setting(b);
                System.out.println("iam here+++++++"+b.length);
