...
import dataPlacement.FuzzyBuildTime;
...
public class FlexiSimulator extends CloudSimulator
{
	...
	public String simulateWorkflow(Workflow aWorkflow) throws DistributionException
	{
		...
		//appel pour fcm
	//	FuzzyBuildTime fcm =new FuzzyBuildTime(fDatacenters,fBuildtime.getDependancyMatrixClustered(),lUtilisedCenters.size());
		//fcm.tostring();
	//	System.out.println("---lUtilisedCenters---"+lUtilisedCenters.toString());
	//	ArrayList<DataCenter> lUtilisedCentersFuzzy = fBuildtime.distributeFuzzy(fBuildtime.getDependancyMatrixClustered());
		///////////////////////////////////////////////
	...
	//	FcmPartition ff = new FcmPartition(lUtilisedCenters,fClusteredMatrix);
		...
		//fuzRuntime.run(fDatacenters, aWorkflow);
