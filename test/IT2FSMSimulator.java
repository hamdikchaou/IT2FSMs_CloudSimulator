...
import dataPlacement.IT2FsmPartition;
import dataPlacement.RuntimeAlgorithm;
import dataPlacement.Matrix;
import workflow.Workflow;

public class IT2FSMSimulator extends CloudSimulator
{
	...
	public IT2FSMSimulator(ArrayList<DataCenter> aDataCenters, RuntimeAlgorithm aRuntime, BuildTimeAlgorithm aBuildtime)
	{
		super(aDataCenters);
		fRuntime = aRuntime;
	...
	public String simulateWorkflow(Workflow aWorkflow) throws Exception
	{
		...
		/******************************************************************************************************/
		IT2FsmPartition ff = new IT2FsmPartition(lUtilisedCenters,fClusteredMatrix);
