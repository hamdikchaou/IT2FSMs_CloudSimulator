...
public class Example {
	...
	public static void main(String[] args) {
		...
		Swarm swarm = new Swarm(Swarm.DEFAULT_NUMBER_OF_PARTICLES, new net.sourceforge.jswarm_pso.example_1.MyParticle(), new net.sourceforge.jswarm_pso.example_1.MyFitnessFunction());
